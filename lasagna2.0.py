"""
Line 39 [C0325 superfluous-parens] : ["Unnecessary parens after 'return' keyword"] was reported by Pylint.
...
Recommended
Line 52 [C0325 superfluous-parens] : ["Unnecessary parens after 'return' keyword"] was reported by Pylint.

Which means this code doesn't follow general code style conventions. While this type of issue generally doesn't affect the way code executes, it can hurt readability or the performance of automated tools such as documentation generators or test runners.

Recommended
Line 53 [C0305 trailing-newlines] : ["Trailing newlines"] was reported by Pylint.
